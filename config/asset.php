...
add_action('admin_init', function () {
    ...
    wp_register_style('backupolator-admin-font', plugins_url('asset/fonts/sans/fonts.css', BACKUPOLATOR_FILE), [], BACKUPOLATOR_VERSION);
    wp_register_style('backupolator-admin-font-social', plugins_url('asset/fonts/social/fonts.css', BACKUPOLATOR_FILE), [], BACKUPOLATOR_VERSION);
